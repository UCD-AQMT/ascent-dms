'''
For keeping track of the instrument settings listed at the top of the data file
'''
...
class InstrumentSettings():
    ...
    def update_database(self, first_record_date: datetime, db: SmpsDatabase):
    ...
    def _compare_field(self, field_name: str, db_record: dict, record_date: datetime, db: SmpsDatabase):
    ...
    def _end_field(self, db_record: dict, record_date: datetime, db: SmpsDatabase):
        ''' field not found in file but found in database '''
        record_id = db_record['id']
        db.end_settings_record(record_id, record_date)

    def _new_field(self, field_name: str, record_date: datetime, db: SmpsDatabase):
